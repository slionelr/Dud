...
function Gpio(gpio, direction, edge, options) {
    ...
    if (!fs[this.gpioPath]) {
        ...
        fs[GPIO_ROOT_PATH + 'export'] = this.gpio;
        ...
        while (!directionSet) {
            try {
                tries += 1;
                fs[this.gpioPath + 'direction'] = direction;
                directionSet = true;
            } catch (e) {
                if (tries === 10000) {
                    throw e;
...
Gpio.prototype.readSync = function () {
    this.readBuffer = fs[this.valueFd];
    // fs.readSync(this.valueFd, this.readBuffer, 0, 1, 0);
    return this.readBuffer === ONE ? 1 : 0;
};
...
Gpio.prototype.write = function (value, callback) {
    ...
    fs[this.valueFd] = writeBuffer;
    // TODO: Call the callback function with parameters.
};
...
Gpio.prototype.direction = function () {
    return fs[this.gpioPath + 'direction'].toString().trim();
};
...
Gpio.prototype.edge = function () {
    return fs[this.gpioPath + 'edge'].toString().trim();
};
...
Gpio.prototype.unexport = function () {
    ...
    fs[GPIO_ROOT_PATH + 'unexport'] = this.gpio;
};
